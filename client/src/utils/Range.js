// this was take from https://github.com/ngokevin/pokery/blob/master/src/classes/Range.js
/* eslint-disable*/
/*
  Deserializes ranges.
*/
...
export default class Range {
  ...
  get(deadCards = []) {
    ...
    function handOkay(hand) {
      return (
        deadCards.indexOf(hand[0]) === -1 && deadCards.indexOf(hand[1]) === -1
      );
    }
  ...
  initRankOnlyPlusHand() {
    ...
    const secondCardRankRange = c.RANKS.slice(
      c.RANK_INDEX[cards[1]],
  ...
  initOffSuitedPlusHand() {
    ...
    let secondCardRankRange = c.RANKS.slice(
      c.RANK_INDEX[cards[1]],
      c.RANK_INDEX[cards[0]]
    );
